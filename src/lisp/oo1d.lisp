...
It will recursively loop through the has and will call
car on each element in has.

TODO 1b. Why is message set to a gensym?
The program will create a unique name so that it elminates
the possiblity of clashes in the macro expansion with names
used in that expansion. 
